...
<p align="center"><em>画像を集める — 来自 <a href="https://danbooru.donmai.us">Danbooru</a> 和 <a href="https://yande.re">Yande.re</a> 的图片批量采集工具，提供可视化 Web 界面，支持实时日志、暂停继续、下载记录管理。</em></p>
...
```
┌─────────────────────────────────────────────────────┐
│  🕷 图片爬虫控制台              Danbooru & Yande.re  │
├──────────────────┬──────────────────────────────────┤
│  Danbooru│Yande  │  Danbooru 日志 │ Yande.re 日志   │
│──────────────────│─────────────────────────────────-│
│  搜索词          │  [状态栏]  空闲/运行中/已暂停     │
│  保存目录        │                                   │
│  [含已删除] 开关 │  2025-01-01 [INFO] 正在搜索...   │
│  [▶开始] [⏸暂停]│  2025-01-01 [INFO] 下载: xxx.jpg │
│──────────────────│                                   │
│  下载记录        │                                   │
│  D hatsune_miku  │                                   │
│  Y shingeki ...  │                                   │
...
| 状态指示灯 | 绿色呼吸=运行中，橙色=已暂停，绿色常亮=完成，红色=出错 |
